    ...
    function Verify(){
        ...
        <body style=font-family: 'Poppins';padding: 5px;background-color: #ededed; display: flex; align-items: center; justify-content: center;'>
            <div class='mail' style='width: 480px; background-color: #FFFFFF;'>
                ...
                <div class='body' style='padding: 5px; color: #122023'>
                    <p>Welcome to Habere $user_name,</p>
                    <p style='color: #122023;'>Keep your Habere Account secure by verifying your email address.</p>
                    <p style='color: #122023;'>To verify your email, here is your One Time Password Code:</p>
                    <h2>$otp</h2>
                </div>
                <footer style='
                    display: flex;
        ...
        // Add a subject
        $otpmail->Subject = 'Habere Email Verification';
        // Add a message body, for this use OTP
        $otpmail->Body = $message;
