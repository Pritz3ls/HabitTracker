...
<body>
    ...
    <section id="creators" class="creators">
        ...
        <div class="creators-container"> 
            <div class="creator">
                <img src="resource/cont-ian.jpg" alt="Ian" width="120" height="120"> 
                <h2>Ian</h2>
                <p></p>   
            </div>
            <div class="creator">
                <img src="resource/cont-gyles.jpg" alt="Gyles" width="120" height="120"> 
                <h2>Gyles</h2>
                <p>.</p>   
            </div>
            <div class="creator">
                <img src="resource/cont-prince-profile.jpg" alt="Prince" width="120" height="120"> 
                <h2>Prince</h2>
                <p></p>   
            </div>
        </div>
